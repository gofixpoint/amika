...
Both presets include an ENTRYPOINT that runs `/opt/setup.sh` before the main command. By default this is a no-op script. Use `--setup-script` to inject your own setup logic:
