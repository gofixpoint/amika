...
- **Run anywhere.** Create Rigs on Kubernetes nodes, sandbox clouds (E2B, Daytona, Vercel, etc.), or (soon) your own computer.
...
![Amika Rig dashboard showing OpenCode and Pi coding agents, exposed services, and Rig controls.](docs/assets/amika-sandbox-dashboard.png)
...
- **run on any computer or cloud**: You should be able to slice any computer up into Rig workstations — the desktop in your closet, a Rig on E2B, a node in your Kubernetes cluster
- **config-as-code**: your Rig configuration and agent workflows are just code in a git repo; you can pick which config to use per Rig, with per-user config customization
...
- the UIs and interfaces to work with the agents and Rigs
...
- `sandbox-image`: Rig VM snapshots + images. Defines the Rig environment for the agents ([docs](./sandbox-image/README.md))
